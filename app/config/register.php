    ...
    // Recoger datos del formulario
        ...
        if(mysqli_num_rows($user_query) > 0 || mysqli_num_rows($nan_query) > 0) {
            ...
            $user_insert = mysqli_query($conn, "INSERT INTO Erabiltzailea (nan, izena, jaiotze_data, tlf, email, pasahitza) VALUES ('$nan', '$izena', '$data', '$zenbaki', '$email', '$pasahitza')") or die (mysqli_error($conn));

            if ($user_insert) {
                echo "Erabiltzilea erregistratu da.";
            } else {
